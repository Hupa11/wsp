...
// --- MODIFIED FUNCTION START (RAM FIX) ---
const prepareWAMessageMedia = async (message, options) => {
    ...
    // Fixed: Using file paths instead of streams to save RAM
    ...
    const [{ mediaUrl, directPath, handle }] = await Promise.all([
        (async () => {
            // Fixed: Uploading file path directly
        ...
        (async () => {
            try {
                if (requiresThumbnailComputation) {
                    // Fixed: Generating thumbnail from file path
